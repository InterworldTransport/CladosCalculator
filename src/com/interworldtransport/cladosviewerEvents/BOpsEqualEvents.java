...
---com.interworldtransport.cladosviewer.BOpsEqualEvents------------------------------------------
<p>
 ...
 *  Is the Monad equal to another Monad?
 *
 ...
 */
    public BOpsEqualEvents(	ViewerMenu pGUIMenu,
    ...
    }//end of BOpsEqualEvents constructor
 ...
 */
	...
	{
		test=Monad0.isEqual(Monad1);
	}

	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad is judged equal to the first.\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad is judged unequal to the first.\n");
	}

    }//end of action performed method.

 }//end of BOpsEqualEvents class
