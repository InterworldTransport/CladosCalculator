 ...
 */
	...
	try
	{
		test=MonadRealF.isNilpotent(Monad0);
	}
	...
	if (test)
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Monad is judged as nilpotent.\n");
	}
	else
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Monad is judged as not nilpotent.\n");
	}
