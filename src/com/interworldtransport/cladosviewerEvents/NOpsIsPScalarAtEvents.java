 ...
 */
    ...
    public void actionPerformed(ActionEvent evt)
    {
    	...
    	if (test)
			_parent._GUI._StatusBar.setStatusMsg("-->Selected monad's algebra IS PSCALAR in the next nyad.\n");
		else
			_parent._GUI._StatusBar.setStatusMsg("-->Selected monad's algebra IS NOT PURELY PSCALAR in the next nyad.\n");
    }
