 ...
 */
	...
	{
		test=MonadRealF.isReferenceMatch(Monad0, Monad1);
	}

	if (test)
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Second Monad is judged a reference match with the first.\n");
	}
	else
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Second Monad is judged not at reference match with the first.\n");
	}
