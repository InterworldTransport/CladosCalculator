 ...
 */
    public SOpsMagnitudeEvents(	ViewerMenu pGUIMenu,
 ...
 */
    public void actionPerformed(ActionEvent evt)
    {
		...
		if (scale != null)
    	{
    		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Monad magnitude is: \n");
			ParentGUIMenu._parentGUI._StatusBar.setWhatFloat(scale.getModulus());
    	}
    	else
    	{
    		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Monad couldn't produce a magnitude. \n");
    	}
    }
 }
