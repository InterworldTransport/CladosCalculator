 ...
 */
    public COpsAddEvents(	ViewerMenu pGUIMenu,
    ...
    public void actionPerformed(ActionEvent evt)
    {
    	...
    	if (Monad0!=null || Monad1!=null)
    	{
    		try
    		{
				...
				ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Second Monad added to the first.\n");
    		}
    		catch (FieldBinaryException eb)
    		{
    			ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Field Binary error between second and first monads.\n");
				ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Second Monad not added to the first.\n");
    		}
    		...
    		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Addition requires two monads. No addition occured.\n");
    }
 }
