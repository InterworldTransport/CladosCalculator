 ...
 */
    ...
    }//end of COpsAddEvents constructor
 ...
 */
	...
	if (Monad0!=null || Monad1!=null)
	{
		try
		{
			...
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad added to the first.\n");
		}
		catch (NoReferenceMatchException e)
		{
			...
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad not added to the first.\n");
		}
	}
	else
	{
