 ...
 */
	...
	test=Monad0.isMultiGrade();

	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged as multigraded.\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged as not multigraded.\n");
	}
