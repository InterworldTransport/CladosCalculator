 ...
 *  Wedge this Monad with another Monad.
 *
 ...
 */
    ...
    }//end of COpsWedgeEvents constructor
 ...
 */
	...
	if (Monad0!=null || Monad1!=null)
	{
		...
		catch (NoReferenceMatchException e)
		{
			...
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad not wedged against the first.\n");
		}
		catch (WedgeDefinitionException d)
		{
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Wedge Definition error between second and first monads.\n");
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad not wedged against the first.\n");
		}
