 ...
 */
	...
	try
	{
		Monad0.GradeSupress(new Integer(ParentGUIMenu.ParentGUI.StatusLine.stview.getText()).intValue());
		MP0.setBottomFields();
		test=true;
	}
	...
	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad has suppressed grade: {"+
				ParentGUIMenu.ParentGUI.StatusLine.stview.getText()+"}\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad has not suppressed grade: {"+
				ParentGUIMenu.ParentGUI.StatusLine.stview.getText()+"}\n");
	}
    }//end of action performed method.

 }//end of SOpsGradeSupressEvents class
