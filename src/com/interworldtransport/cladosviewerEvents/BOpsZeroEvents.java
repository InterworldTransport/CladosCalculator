...
---com.interworldtransport.cladosviewer.BOpsZeroEvents------------------------------------------
<p>
 ...
 */
    public BOpsZeroEvents(	ViewerMenu pGUIMenu,
    ...
    }//end of BOpsZeroEvents constructor
 ...
 */
	...
	if (MonadRealF.isGZero(Monad0))
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("First Monad is judged an additive unity.\n");
	}
	else
	{
		ParentGUIMenu._parentGUI._StatusBar.setStatusMsg("Second Monad is judged not an additive unity.\n");
	}

    }//end of action performed method.

 }//end of BOpsZeroEvents class
