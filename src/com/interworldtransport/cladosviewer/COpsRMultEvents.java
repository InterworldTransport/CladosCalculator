 ...
 */
    ...
    }//end of COpsRMultEvents constructor
 ...
 */
	...
	if (Monad0!=null || Monad1!=null)
	{
		try
		{
			...
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad muliplied against the first from the right.\n");
		}
		catch (NoReferenceMatchException e)
		{
			...
			ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad not muliplied against the first from the right.\n");
		}
	}
	else
	{
