 ...
 */
	...
	boolean test=Monad0.isZero();

	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged an additive unity.\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("Second Monad is judged not an additive unity.\n");
	}
