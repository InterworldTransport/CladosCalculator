 ...
 */
	...
	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged as pure grade match for grade: {"+
					ParentGUIMenu.ParentGUI.StatusLine.stview.getText()+"}\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged not a pure grade match for grade :{ "+
					ParentGUIMenu.ParentGUI.StatusLine.stview.getText()+"}\n");
	}
