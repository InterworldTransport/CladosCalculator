 ...
 */
	...
	try
	{
		test=Monad0.isIdempotentMultiple();
	}
	...
	if (test)
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged as idempotent multiple.\n");
	}
	else
	{
		ParentGUIMenu.ParentGUI.StatusLine.setStatusMsg("First Monad is judged as not idempotent multiple.\n");
	}
