...
public class NOpsIsPScalarAtEvents implements ActionListener {
	 ...
	 */
	public NOpsIsPScalarAtEvents(JMenuItem pmniControlled, NOpsParentEvents pParent) {
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (test)
			...
			_parent._GUI.appStatusBar
					.setStatusMsg("-->Selected monad's algebra IS NOT PURELY PSCALAR in the next nyad.\n");
	}
