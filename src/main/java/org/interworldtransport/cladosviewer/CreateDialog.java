...
public class CreateDialog<T extends ProtoN & Field & Normalizable> extends JDialog implements ActionListener {
	 ...
	 *         later.
	 */
	public static final <T extends ProtoN & Field & Normalizable> CreateDialog<T> createMonad(
	 ...
	 *         later.
	 */
	public static final <T extends ProtoN & Field & Normalizable> CreateDialog<T> createNyad(
			CladosCalculator pGUI, CladosField pMode) {
